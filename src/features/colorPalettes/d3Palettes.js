...
const d3SequentialInterpolators = {
...
const d3DivergingInterpolators = {
    // Diverging
...
//
const categoricalPalettes = Object.entries(d3Schemes).reduce(
    (acc, [key, value]) => {
...
const divergingPalettes = Object.entries(d3DivergingInterpolators).reduce(
    (acc, [key, value]) => {
